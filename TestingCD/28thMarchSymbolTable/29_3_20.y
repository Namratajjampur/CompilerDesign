...
statement
	...
	;
switch_statement
: SWITCH '(' expression ')' '{' new_scope case_statement '}' new_scope_end{printf("switch\n");}
;
constant_expression
...
while_statement
	: WHILE '(' expression ')' compound_statement {printf("238\n");}
	;
