...
%token keyword number id label relop logop unaryop arithop assign num double int struct break long switch case typedef char return void while default float bool
