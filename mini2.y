...
%token PREPROC STRING CHARACTER MAIN INT STRUCT BREAK SWITCH CASE TYPEDEF CHAR RETURN VOID WHILE DEFAULT FLOAT BOOL NUM NUMBER ID RELOP LOGOP UNARYOP ASSIGN ARITHOP1 ARITHOP2
...
/* Rule Section */
%%
PROGRAM : PREPROC_DIRECTIVE INT MAIN '('')''{'STATEMENT'}'
| PREPROC_DIRECTIVE STRUCTURE VOID MAIN '('')''{'STATEMENT'}'
| PREPROC_DIRECTIVE VOID MAIN '('')''{'STATEMENT'}'
| PREPROC_DIRECTIVE STRUCTURE INT MAIN '('')''{'STATEMENT'}'
;
