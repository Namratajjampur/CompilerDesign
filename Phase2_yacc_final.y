...
STRUCTINTERNALS: DECLARATIONA';'STRUCTINTERNALS
| DECLARATIONA';'
;
DECLARATIONA: DATATYPE DECTYPEA
;
DECTYPEA: DECEXPA','DECTYPEA
| DECEXPA
;
DECEXPA: DECIDA
;
...
|
;
A:IDLOOP|MULTI IDLOOP
;
ASSIGNMENT: ID IDLOOP ASSIGN EXPRESSION
| ID MULTI IDLOOP ASSIGN EXPRESSION
| ID IDLOOP ASSIGN '{'EXPRESSION_SET'}'
| ID MULTI IDLOOP ASSIGN '{'EXPRESSION_SET'}'
;
...
|F
;
F: ID MULTI IDLOOP UNARYOP
| ID IDLOOP UNARYOP
| UNARYOP ID MULTI IDLOOP
| UNARYOP ID IDLOOP
| M
;
M: ID IDLOOP
